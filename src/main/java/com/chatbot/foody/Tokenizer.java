...
/**
 * Class com.chatbot.foody.Tokenizer is a class that uses a StringTokenizer object to isolate all the words from the user's message.
 *
 * A com.chatbot.foody.Tokenizer object has a String field that is the user's message, called msg and another String field that
 * is the delimiter for the StringTokenizer object which is set to the default space character. The default operation
 * of a com.chatbot.foody.Tokenizer object is to return a List containing all the words from the user's message.
 *
