package com.chatbot.foody;//import com.sun.org.apache.xpath.internal.compiler.Keywords;
...
public class ResponseGenerator {
    ...
    /*Restaraunts that will be used in List Menu , List com.chatbot.foody.Restaurant*/
    ...
    private AbstractResponse mapKeywordsToResponse(){
        ...
        switch (msgCode) {
            ...
            case LIST_BRANCH_MENU:
                /*Create class and send com.chatbot.foody.Restaurant IDs*/
